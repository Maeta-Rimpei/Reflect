    ...
    <footer>
      ...
      <section className="relative border-t border-border overflow-hidden">
        ...
        <div className="relative mx-auto flex max-w-5xl flex-col items-center px-6 py-24 text-center md:py-32">
          ...
          <Link
            href="/app"
            className="group mt-8 flex items-center gap-2 rounded-xl bg-foreground/90 px-8 py-3.5 text-sm font-medium text-primary-foreground transition-colors hover:bg-foreground/75"
          >
            {"Start Reflecting"}
